...
% Draw some framed and filled rects. We define the 
% bounding rectangles
...
% TRIANGLE
Screen('FillPoly', win, [0, 0, 1 ], [1000 200; 1100 800; 1200 200]);

Screen('FillPoly', win, [1, 1, 1], [186.8160 588.2602; 192.0000 555.0314; 197.1840 588.2602]);
%Screen('DrawLine', win, [1 0 0], 186.8160, 588.2602, 192.0000, 555.0314, 3);
%Screen('DrawLine', win, [0 1 0], 197.1840, 588.2602, 192.0000, 555.0314, 2);
%Screen('DrawLine', win, [0 0 1], 186.8160, 588.2602, 197.1840, 588.2602, 1);

%Screen('FillPoly', windowPtr, candleCol, [placementRects(1,1) yVals(defaultPlaceOrder(1)); centreX(1) yVals(defaultPlaceOrder(2)); placementRects(3,1) yVals(defaultPlaceOrder(1))]);
...
Screen('FillPoly', win, [0, 0, 1 ], polyPoints);
Screen('FramePoly', win, [1, 1, 1], polyPoints,2);
