function [demoResp, cancelledInput]= candleDemographics
...
%  Originally Created For: 6ix. If you'd like to extend it, please add
%  cases as this will be used for archive and reference moving forward.
%
...
while finished == 0
    finished = 1;
    [demoResp, cancelledInput]= inputsdlgOLD(prompt, name, formats, defaultanswer);
